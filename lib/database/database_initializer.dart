...
class DatabaseInitializer {
  ...
  static Future<void> initialize() async {
    ...
    await isar.writeTxn(() async {
      ...
      final warmageString = await rootBundle.loadString('assets/classes/warmage_fixed.json');
      ...
      final plushieString = await rootBundle.loadString('assets/species/plushie.json');
      ...
      final criminalString = await rootBundle.loadString('assets/backgrounds/criminal.json');
      final criminalJson = jsonDecode(criminalString);
      final criminal = Background.fromJson(criminalJson['background'] ?? criminalJson);
      ...
      final alertString = await rootBundle.loadString('assets/feats/alert.json');
